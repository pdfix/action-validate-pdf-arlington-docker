...
def run_arlington(command: list) -> tuple:
        ...
        if input_file.lower().endswith(".pdf"):
            try:
                command = [
                    "java",
                    "-jar",
                    "/usr/validation/res/greenfield-apps-arlington-1.27.0-SNAPSHOT.jar",
                    "--maxfailuresdisplayed",
                ...
                stdout, stderr, return_code = run_arlington(" ".join(command))
